      ...
      <div className="max-w-4xl mx-auto w-full flex-1 flex flex-col justify-center items-center relative z-10 space-y-8 my-auto">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-[70px] lg:text-[76px] font-serif font-medium tracking-normal leading-[1.15] max-w-3xl mx-auto">
          ...
          <motion.span
            ...
            className="inline-block mt-2 md:mt-3 mb-1 md:mb-2 font-script text-5xl sm:text-7xl md:text-8xl lg:text-[92px] tracking-wide bg-gradient-to-r from-[#F0C965] via-[#D4AF37] to-[#F2D785] bg-clip-text text-transparent drop-shadow-[0_2px_12px_rgba(212,175,55,0.4)] pb-4 pt-1 origin-center"
          >
            {heroTitleAccent}
          </motion.span>
          <motion.span
