  ...
  return (
    <section className="relative py-20 md:py-28 bg-[#030714] overflow-hidden text-center select-none">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-3 flex flex-col justify-between gap-6">
            ...
            <motion.div
              ...
              whileHover={{ y: -6, borderColor: 'rgba(212,175,55,0.5)', boxShadow: '0 15px 35px rgba(212,175,55,0.06)' }}
              className="group flex-1 flex gap-4 text-left p-6 bg-slate-950/40 backdrop-blur-md border border-primary/15 rounded-xl transition-all duration-300 relative overflow-hidden"
            >
              ...
              <div className="flex-shrink-0 flex items-center justify-center w-14 h-14 rounded-full border border-primary/20 bg-primary/5 text-primary group-hover:bg-primary group-hover:text-black transition-all duration-300">
          ...
          <motion.div
            ...
            className="lg:col-span-6 min-h-[350px] lg:min-h-[450px] relative rounded-xl overflow-hidden border-2 border-primary/25 group transition-all duration-500 shadow-[0_10px_40px_rgba(0,0,0,0.4)]"
          >
        ...
        >
          <motion.div
            whileHover={{ y: -5, borderColor: 'rgba(212,175,55,0.4)', boxShadow: '0 15px 35px rgba(212,175,55,0.06)' }}
            className="group flex flex-col sm:flex-row gap-5 items-center sm:items-start text-center sm:text-left p-6 bg-slate-950/40 backdrop-blur-md border border-primary/15 rounded-xl transition-all duration-300 relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-primary/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-out pointer-events-none" />
