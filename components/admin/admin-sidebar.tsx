...
import { LayoutDashboard, ShoppingCart, CalendarDays, ChefHat, BookOpen, Settings, Users, BarChart3, Activity, ClipboardList, Truck, Mail, Layers, Star } from 'lucide-react';
...
export default function AdminSidebar({ isOpen = false, onClose }: AdminSidebarProps) {
  ...
  const operationsItems = [
    ...
    { href: ROUTES.admin.reviews, key: 'reviews', icon: Star },
