...
const cspHeader = [
  ...
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://maps.googleapis.com https://api.websub.co https://vercel.live wss://vercel.live https://translate.googleapis.com https://unpkg.com",
